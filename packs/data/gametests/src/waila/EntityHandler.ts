...
import { EntityRenderData } from "../types/LookAtObjectMetadataInterface";
...
export class EntityHandler {
  ...
  static transformEntityId(entity: Entity): string {
    const IGNORE_IDS = [
      "area_effect_cloud", "fireball", "minecart", "potion",
      "minecraft:arrow", "minecraft:boat", "minecraft:egg",
      "minecraft:eye_of_ender_signal", "minecraft:item",
      "minecraft:snowball", "minecraft:tnt"
    ];
   ...
   */
  static effectsRenderer(entity: Entity): { effectString: string; effectsResolvedArray: string[] } {
